...
<Button className="bg-gra-100 hover:bg-gray-50 text-zinc-500 self-end mb-2"
...
<nav className="flex flex-col gap-1 overflow-hidden">
 ...
 <SidebarLink
            ...
            <div className={clsx('flex flex-1 flex-col transition-all duration-300', {
                ...
                items-center justify-between border-b px-6 md:px-6 h-14 
                z-10 sticky top-0 bg-white">
                    <Sheet>
                        <div className="flex items-center gap-4">
                            ...
                            <h1 className="text-base md:text-lg font-semibold">Menu OdontoFlow</h1>
                        </div>
                        <SheetContent side="right" className="sm:max-w-xs text- px-6 py-4">
                            <SheetTitle>OdontoFlow</SheetTitle>
    ...
    return (
        ...
        >
            <div className={clsx("flex items-center gap-2 px-3 py-2 rounded-md transition-colors",{
                ...
                "text-gray-700 hover:bg-gray-500": pathname !== href,
